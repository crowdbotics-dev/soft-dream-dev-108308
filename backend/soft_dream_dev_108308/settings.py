"""
Django settings for soft_dream_dev_108308 project.
...
ROOT_URLCONF = 'soft_dream_dev_108308.urls'
...
WSGI_APPLICATION = 'soft_dream_dev_108308.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_dream_dev_108308 API",
    "DESCRIPTION": "API documentation for soft_dream_dev_108308 App",
    "VERSION": "v1",
}
